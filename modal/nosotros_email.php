...
<div class="modal fade" id="email" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content" id="cotizacion_content">
      <div class="modal-header" id="cotizacion_header">
      ...
      <div class="modal-body">
        <form class="form_email" action="" method="POST">
            ...
            <input class="input_email" type="email" placeholder="Correo" name="correo">
           ...
           <input class="submit_email btn btn-danger btn-sm"  type="submit">
        </form>
      </div>
